...
export function createComponent(componentElem) {
    ...
    const inputListContainer = componentElem.querySelector('.app-cmp-number-list');
    if (inputListContainer === null) {
        throw new Error('Input list container .app-cmp-number-list is not found within the section component.');
    }
    const regenerateTitleNumbersAndStatus = () => {
        [
            ...
            [
                ...inputContainer.querySelectorAll('.app-title-number'),
